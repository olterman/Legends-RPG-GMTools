    ...
    *,
    ...
    if cosmology_body:
        ...
        items.append(_normalize_lore_item({
            ...
            "excerpt": "AI guide to Lands of Legend cosmology, religion, powers, and drift safeguards.",
            "description": "AI guide to Lands of Legend cosmology, religion, powers, and drift safeguards.",
...
def _build_ai_profession_lore_item(
    ...
    *,
    ...
    item = {
        ...
        "excerpt": f"AI guide for the {role_label} role in Lands of Legend.",
        "description": f"AI guide for the {role_label} role in Lands of Legend.",
